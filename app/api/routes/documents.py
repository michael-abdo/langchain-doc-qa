...
- Estimated code reduction: 30% fewer lines, 50% less error handling duplication
"""
# DRY CONSOLIDATION: Using consolidated imports
from app.core.common import (
    get_api_logger, ApiResponses,
    Optional, List, UUID, asyncio
)
...
@with_api_error_handling("list_documents")
...
@with_api_error_handling("get_document")
...
@with_api_error_handling("update_document")
...
@with_api_error_handling("delete_document")
...
@with_api_error_handling("search_documents")
async def search_documents(
    ...
    }, f"Found {len(response_data)} matching documents")